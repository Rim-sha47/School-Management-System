  ...
  <div class="topbar-actions">
    ...
    <div class="dropdown">
      <button class="topbar-profile" data-bs-toggle="dropdown" aria-label="Profile menu">
        <div class="topbar-avatar" style="background:var(--success);"><?php echo strtoupper(substr($_SESSION['username'] ?? 'ST', 0, 2)); ?></div>
        <div class="topbar-profile-info d-none d-sm-block">
          <div class="topbar-profile-name"><?php echo htmlspecialchars($_SESSION['username'] ?? 'Student'); ?></div>
